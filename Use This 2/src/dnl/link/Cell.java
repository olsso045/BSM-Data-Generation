...
public class Cell 
{
    ...
    public void step()
    {
        ...
        if(next!=null) {
            ...
            OutFlow =  Math.round(Math.min(this.getSendingFlow(), next.getReceivingFlow()));  
    //        if(this.link.id == 23 && this.CellId == 1) {
    ...
    //        System.out.print(next.getReceivingFlow());
        ...
        if(prev!=null) {
            ...
            InFlow =  Math.round(Math.min(prev.getSendingFlow(), this.getReceivingFlow()));
        }
...
//                }
    ...
    public double getSendingFlow()
    {
     ...
     //   if(LinkIDE == 23 && this.CellId == 3) {
        //    System.out.println(Math.min(Q, this.VehiclesInCell.size())); }
